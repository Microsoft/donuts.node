...
declare export function writeMoreAsync(properties: Donuts.IStringKeyDictionary<string>, severity: Donuts.Logging.Severity, messageOrFormat: string, ...params: Array<any>): Promise<Donuts.Logging.ILog>;
...
declare export function writeExceptionAsync(exception: Error, properties?: Donuts.IStringKeyDictionary<string>): Promise<Donuts.Logging.ILog>;
declare export function writeEventAsync(name: string, properties?: Donuts.IStringKeyDictionary<string>): Promise<Donuts.Logging.ILog>;
declare export function writeMetricAsync(name: string, value?: number, properties?: Donuts.IStringKeyDictionary<string>): Promise<Donuts.Logging.ILog>;
