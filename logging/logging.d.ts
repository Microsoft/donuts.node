...
declare module "donut.node/logging" {
    import { Component } from "donut.node/module-manager";
    import { IDictionary, IDisposable } from "donut.node/common";
...
declare module "donut.node/module-manager" {
    import { ILog, ILoggerSettings, ILogger } from "donut.node/logging";
