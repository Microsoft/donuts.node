...
declare export abstract class ChannelProxy<TChannel> implements Donuts.Remote.IChannelProxy {
    ...
    public abstract sendData(data: any): void;
    ...
    public setHandler(type: "error", handler: Donuts.Remote.ChannelProxyDataHandler): this;
    ...
    protected triggerHandler(type: "error", err: Error): void;
